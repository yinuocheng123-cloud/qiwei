...
const actionOptions = [
  ...
  { value: "market_claw_knowledge_scope_updated", label: "更新 Market Claw 知识层级" },
  { value: "market_claw_ingestion_batch_created", label: "创建 Market Claw 资料投喂批次" },
  { value: "market_claw_ingestion_candidates_generated", label: "生成 Market Claw 候选知识" },
  { value: "market_claw_knowledge_candidate_similarity_checked", label: "检查 Market Claw 候选知识相似度" },
  { value: "market_claw_knowledge_candidate_adopted", label: "采纳 Market Claw 候选知识" },
  { value: "market_claw_knowledge_candidate_rejected", label: "驳回 Market Claw 候选知识" },
  { value: "market_claw_knowledge_candidate_merged", label: "合并 Market Claw 候选知识" },
  { value: "market_claw_knowledge_candidate_appended", label: "追加 Market Claw 候选知识到已有知识" },
  { value: "market_claw_knowledge_candidate_rejected_as_duplicate", label: "重复驳回 Market Claw 候选知识" },
  { value: "market_claw_knowledge_source_updated", label: "更新 Market Claw 知识来源记录" },
  { value: "market_claw_training_generated", label: "生成 Market Claw 训练结果" },
  { value: "market_claw_personal_training_created", label: "创建销售个人训练" },
  { value: "market_claw_personal_reply_saved", label: "保存个人常用话术" },
  { value: "market_claw_training_submitted_for_review", label: "提交训练审核" },
  { value: "market_claw_training_reviewed", label: "审核训练样本" },
  { value: "market_claw_training_adopted_as_team", label: "采纳为团队标准" },
  { value: "market_claw_training_adopted_as_enterprise", label: "采纳为企业标准" },
  { value: "market_claw_training_rejected", label: "驳回训练样本" },
...
const entityTypeOptions = [
  ...
  { value: "MarketClawIngestionBatch", label: "Market Claw 投喂批次" },
  { value: "MarketClawKnowledgeCandidate", label: "Market Claw 候选知识" },
