...
const customerTypeAliasMap = new Map<string, CustomerType>([
  ...
  ["潜在客户", CustomerType.OWNER_CLIENT],
  ["DEALER_CLIENT", CustomerType.DEALER_CLIENT],
  ["合作伙伴", CustomerType.DEALER_CLIENT],
  ["DESIGNER_CLIENT", CustomerType.DESIGNER_CLIENT],
  ["意向客户", CustomerType.DESIGNER_CLIENT],
  ["FACTORY_CLIENT", CustomerType.FACTORY_CLIENT],
  ["重点客户", CustomerType.FACTORY_CLIENT],
  ...
  ["重点客户", CustomerType.PLATFORM_FACTORY_OWNER],
  ...
  ["增长推广客户", CustomerType.PLATFORM_GEO_AI_CLIENT],
  ["增长推广客户", CustomerType.PLATFORM_GEO_AI_CLIENT],
  ...
  ["活动／活动资源客户", CustomerType.PLATFORM_EVENT_RESOURCE_CLIENT],
  ["活动/活动资源客户", CustomerType.PLATFORM_EVENT_RESOURCE_CLIENT],
